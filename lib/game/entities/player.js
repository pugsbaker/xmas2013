...
EntityPlayer = ig.Entity.extend({
    ...
    sfxJump: new ig.Sound('content/media/sfx/jump.*'),
    sfxFall: new ig.Sound('content/media/sfx/fall.*'),

    init: function(x, y, settings){
        
        this.pathtosheet = "content/media/playersprites/player_sprite_" + ig.chosenPlayer + ".png"
